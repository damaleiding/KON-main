...
```bash
node tools/word-count/word-count.mjs projects/novel/outputs/chapter01.md
```

macOS / Linux：

```bash
./tools/word-count/word-count.sh projects/novel/outputs/chapter01.md
```
...
```powershell
.\tools\word-count\word-count.ps1 -Json .\projects\novel\outputs
```
...
```powershell
.\tools\word-count\word-count.ps1 -Details .\projects\novel\outputs
```

只统计汉字：

```powershell
.\tools\word-count\word-count.ps1 -Mode cjk .\projects\novel\outputs\chapter01.md
```
