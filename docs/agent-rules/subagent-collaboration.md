...
- 不应把密钥、token、cookie、私有账号、未脱敏客户资料或大体积外部资料直接发送给子 Agent。
...
- 新增工具、封装脚本、设计 schema、账本、索引或文本版本清单。
- 迁入外部项目、梳理项目用途、判断文本、资料归类和长期维护边界。
...
- 用户明确要求快速执行且任务风险低。
- 子 Agent 需要接触密钥、token、cookie、未脱敏客户资料或大体积外部资料。
